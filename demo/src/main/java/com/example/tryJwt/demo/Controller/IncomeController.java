...
import com.example.tryJwt.demo.Services.IncomeService;
...
public class IncomeController {
    ...
    private static final String urlBase = "api/income";

    @GetMapping("/get_all")
    public ResponseEntity<MovementsPagedResponse> listaIngresos(@RequestParam Map<String, String> params)
    {
