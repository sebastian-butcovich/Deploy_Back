...
public interface IncomeRepository extends JpaRepository<Income,Integer> {
    ...
    @Query(value = "select * from income  where id_autor = ?1 and fecha between ?2 and ?3 order by fecha",nativeQuery = true)
    public List<Income> findAllByUsuarioFecha(Integer id, String fecha_inicio,String fecha_fin);
}
